...
class NewsClient(BaseClient):
    ...
    async def get_news(self, country:str, category:str = "business") -> Optional[dict]:
        """
        ...
        return await self._request(
            f"{await self.get_base_url()}/top-headlines?country={country}&category={category}&apiKey={API_KEY_NEWSAPI}"
        )